    ...
    <div className="mx-auto max-w-6xl p-4 md:p-8 text-slate-900">
      ...
      <Accordion type="multiple" defaultValue={["isp","voip","wifi","access","cloud","mobile"]} className="space-y-4">
        {(Object.keys(data) as CategoryKey[]).map((k)=> (
          <AccordionItem key={k} value={k} className="border-slate-200 rounded-xl overflow-hidden">
            <AccordionTrigger className="px-4 md:px-6 hover:no-underline bg-white">
      ...
      <section className="mt-8 grid md:grid-cols-5 gap-6 items-start">
        ...
        <div className="md:col-span-2 h-72 bg-white border border-slate-200 rounded-2xl p-4">
